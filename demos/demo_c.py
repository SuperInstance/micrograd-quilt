...
(decode → rebuild → evaluate → binary viability floor → empty-cell novelty).
The real negative-space GAN breeds these tapes from the-tap PR #7 via the
composition seam; nothing here is MAP-Elites.

Run: python3 demos/demo_c.py
"""
